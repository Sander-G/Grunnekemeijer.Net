  ...
  },
  {
    ...
    text: (
      <>
        ...
        ). Na enig worstelen met endpoints die niet werkten zoals verwacht heb ik de database JSON data gekopieerd en geprobeerd deze data lokaal te fetchen - mijn introductie met
        <Italics>CORS errors.</Italics> Het resultaat is een pagina met 1st Gen. Transformers gemapped vanuit een JSON bestand, met een modal voor grotere weergave.
        <a href='https://jseindopdrachtsanderg.netlify.app/json_cards/' target='_blank' rel='noopener noreferrer'>
          <TextShadow> Hier </TextShadow>
        </a>
        een live versie van de Transformer Index en een paar andere Javascript opdrachten die ik tijden de opleiding heb gemaakt.
      </>
    ),
  },
];
