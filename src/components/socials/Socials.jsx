  ...
  return (
    <Container>
      ...
      <a
        ...
        onClick={handleClick} onMouseEnter={handleMouseEnterLocal} onMouseLeave={handleMouseLeaveLocal}
      >
        <svg stroke='currentColor' fill='currentColor' strokeWidth='0' viewBox='0 0 16 16' height='30px' width='30px' aria-label='Sander&#39;s Github' role='presentation'>
      ...
      >
        <svg stroke='currentColor' fill='currentColor' strokeWidth='0' viewBox='0 0 16 16' height='30px' width='30px' aria-label='Sander&#39;s LinkedIn' role='presentation'>
      ...
      >
        <svg
          ...
          height='30px'
          width='30px'
          aria-label='Sander&#39;s Instagram waar hij al een paar jaar niet meer naar omkijkt'
          role='presentation'
        >
          <title lang='nl'>Sander&#39;s Instagram waar hij al een paar jaar niet meer naar omkijkt</title>
