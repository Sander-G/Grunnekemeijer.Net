...
export default function Flashlight() {
  ...
  return (
    <>
      <Wrapper>
        <FlashlightButton onClick={() => { setIsOn(!isOn) }} onMouseEnter={() => {
          ...
          {!isOn ? (
            <svg fill="currentColor" height="22px" width="22px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 512 512" >
              <g>
                <g>
            ...
            : (<svg fill="currentColor" height="22px" width="22px" version="1.1" id="Layer_1" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
              <g>
                <g>
