    ...
    <>
      ...
      >
        {isMuted ? (
          ...
          <svg stroke='currentColor' fill='currentColor' strokeWidth='0' viewBox='0 0 16 16' height='22px' width='22px' aria-labelledby='Geluid aan' xmlns='http://www.w3.org/2000/svg'>
            <title lang='nl'>Geluid uit</title>
            <path
              fillRule='evenodd'
              clipRule='evenodd'
